...
function drawBridge(){
    ...
    for(let i = 0; i < bridge_meshes.length; i++){
        ...
        // index length
        if(wireframe)
            gl.drawElements(gl.LINES, bridge_meshes[i][1], gl.UNSIGNED_SHORT, 0);
        else
...
function drawRoad(){
    ...
    for(let i = 0; i < road_meshes.length; i++){
        ...
        // index length
        if(wireframe)
        gl.drawElements(gl.LINES, road_meshes[i][1], gl.UNSIGNED_SHORT, 0);
        else
...
function drawOcean(){
    ...
    for(let i = 0; i < ocean_meshes.length; i++){
        ...
        // index length
        if(wireframe)
        gl.drawElements(gl.LINES, ocean_meshes[i][1], gl.UNSIGNED_SHORT, 0);
    else
...
function drawCar(){
    ...
    for(let i = 0; i < car_meshes.length; i++){
        ...
        // index length
        if(wireframe)
        gl.drawElements(gl.LINES, car_meshes[i][1], gl.UNSIGNED_SHORT, 0);
    else
...
function drawTown(){
    ...
    for(let i = 0; i < town_meshes.length; i++){
        ...
        if (town_meshes[i].length > 5) {
            ...
            // index length
            if(wireframe)
            gl.drawElements(gl.LINES, town_meshes[i][1], gl.UNSIGNED_SHORT, 0);
        else
...
function drawChopper(){
    ...
    gl.uniformMatrix4fv(nM, 0, normalMatrix);
    if(wireframe)
    gl.drawElements(gl.LINES, chopper_meshes[7][1], gl.UNSIGNED_SHORT, 0);
else    
    ...
    for(let i = 0; i < chopper_meshes.length; i++){
        if(i != 7){
            ...
            // index length
            if(wireframe)
            gl.drawElements(gl.LINES, chopper_meshes[i][1], gl.UNSIGNED_SHORT, 0);
            else    
...
function drawSign(){
    ...
    for(let i = 0; i < sign_meshes.length; i++){
        ...
        if (sign_meshes[i].length > 5) {
            ...
            // index length
            if(wireframe)
    gl.drawElements(gl.LINES, sign_meshes[i][1], gl.UNSIGNED_SHORT, 0);
else    
...
function drawSheep(){
    ...
    for(let i = 0; i < sheep_meshes.length; i++){
        ...
        // index length
        if(wireframe)
    gl.drawElements(gl.LINES, sheep_meshes[i][1], gl.UNSIGNED_SHORT, 0);
else    
...
function drawbus(){
    ...
    for(let i = 0; i < bus_meshes.length; i++){
        ...
        if (i != 0){
            if(wireframe)
    gl.drawElements(gl.LINES, bus_meshes[i][1], gl.UNSIGNED_SHORT, 0);
else    
